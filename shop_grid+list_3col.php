...
<html lang="en">
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-196414914-2"></script>
<script>
          ...
          <div class="row">
            ...
            <div class="col-3">
              <div class="product-function d-flex align-items-center justify-content-end">
                ...
                <div id="login">
                  <a class="function-icon fas fa-user" href="login.html"><span>Iniciar sesion </span> <span></span></a>
                </div>
            ...
            <div class="shop-sidebar">
              ...
              <div class="shop-sidebar_tag">
                ...
                <div class="tag_bottom"><a class="tag-btn" href="shop_grid+list_3col.html">Gamer</a>
                  <a class="tag-btn" href="shop_grid+list_3col.html">Escuela</a>
                  <a class="tag-btn" href="shop_grid+list_3col.html">Oficina</a>
                  <a class="tag-btn" href="shop_grid+list_3col.html">Edición</a>
                  <a class="tag-btn" href="shop_grid+list_3col.html">Negocio</a>
                  <a class="tag-btn" href="shop_grid+list_3col.html">Ocio</a>
                </div>
              </div>
            </div>
                  ...
                  <div id="products" class="row no-gutters-sm">
                    ...
                    ?>
                      <div class="col-6 col-md-4" id="show-products_bottom" id="products">
                        <div class="product">
                          <div class="product-img_block"><a class="product-img" href="shop_detail.php?sku=<?php echo $id_Producto ?>"><img src="<?php echo $imagen ?>" alt=""></a>
                          ...
                          <div class="product-select_list">
                            ...
                            <button id="acart" class="add-to-cart normal-btn outline">Add to Cart</button>
                            <button id="awish" class="add-to-compare normal-btn outline">+ Add to Compare</button>
                          </div>
                        </div>
                      </div>
                    <?php
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#acart').click(function() {
        Swal.fire({
          icon: "warning",
          text: "Debes iniciar sesión para añadir productos!",
        });
      })
