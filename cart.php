...
if (isset($_POST['action'])) {
    ...
    $check="SELECT*FROM carrito where id_Cliente='" . $cliente . "' and id_Producto='" . $producto . "'";
    ...
    $query="INSERT INTO carrito (id_Carrito,id_Cliente,id_Producto) VALUES(NULL,'" . $cliente . "', '" . $producto . "')";
