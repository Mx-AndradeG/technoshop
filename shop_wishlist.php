...
<body>
          ...
          <div class="row">
            ...
            <div class="col-3">
              <div class="product-function d-flex align-items-center justify-content-end">
                ...
                <div id="wishlist"><a class="function-icon icon_heart_alt"></a></div>
  ...
  <div class="ogami-breadcrumb">
    <div class="container">
      <ul>
        ...
        <li> <a class="breadcrumb-link" href="products.php">Tienda</a></li>
        <li> <a class="breadcrumb-link active">Lista de Deseos</a></li>
      </ul>
    </div>
  </div>
  <!-- End breadcrumb-->
  <div class="shopping-cart">
    ...
    $listado = $producto->readDeseo($idC);
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td class="product-name"><a href="product_detail.php?sku=<?php echo $id ?>"><?php echo $modelo ?></a></td>
                    <td class="product-price"><?php echo number_format($precio) ?></td>
                    <td class="product-clear">
                      <button class="no-round-btn delete-productw"><i class="icon_close"></i></button>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
