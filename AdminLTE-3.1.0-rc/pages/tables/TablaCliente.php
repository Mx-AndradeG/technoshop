    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 ">
            ...
            <a href="../../admin.php" class="brand-link">
                <img src="../../assets/index/miniLogo.png" alt="TechnoShop Logo" class="brand-image img-circle elevation-3" style="opacity: 0.8" />
           ...
           with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="../tables/TablaDescuento.php" class="nav-link ">
                                        <i class="fas fa-dollar-sign nav-icon"></i>
                                        <p>Descuento</p>
                                    </a>
                                </li>
